...
class AnimauxManager extends Model{
    public function getAnimaux(){
        ...
        $req = "SELECT animal.animal_id , animal.animal_nom, animal.animal_description, animal.animal_image,animal.famille_id
        FROM animal
        INNER JOIN famille ON animal.famille_id = famille.famille_id
